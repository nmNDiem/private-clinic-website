...
public class Schedule implements Serializable {
    ...
    private Set<DoctorsSchedule> doctorsScheduleSet;
    @OneToMany(mappedBy = "scheduleId")
    private Set<NursesSchedule> nursesScheduleSet;
    ...
    @XmlTransient
    public Set<DoctorsSchedule> getDoctorsScheduleSet() {
        return doctorsScheduleSet;
    }

    public void setDoctorsScheduleSet(Set<DoctorsSchedule> doctorsScheduleSet) {
        this.doctorsScheduleSet = doctorsScheduleSet;
    }

    @XmlTransient
    public Set<NursesSchedule> getNursesScheduleSet() {
        return nursesScheduleSet;
    }

    public void setNursesScheduleSet(Set<NursesSchedule> nursesScheduleSet) {
        this.nursesScheduleSet = nursesScheduleSet;
    }
