...
const BookingForm = () => {
  ...
  const booking = async (e) => {
    ...
    appointmentForm.appointmentDate = moment(appointmentForm.appointmentDate).format('DD/MM/YYYY');
  ...
  return (
    <>
        ...
        <Card>
          ...
          <Card.Body className="bg-info shadow border-0">
            ...
            <Form.Group className="mb-2" controlId="doctorId">
              ...
              <Form.Select value={appointmentForm.doctorId} onChange={e => change(e, "doctorId")}>
                {speciality === null ? <option>Vui lòng chọn chuyên khoa trước</option>
                  : doctors.length === 0 ?
                    <option className="text-danger">Không có bác sĩ trong khoa này</option>
                    : <>
            ...
            <Form.Group className="mb-2" controlId="shift">
              ...
              <Form.Select value={appointmentForm.shift} onChange={e => change(e, "shift")}>
      ...
      <ToastContainer className="my-3 position-fixed" position="top-center" style={{ zIndex: 1 }}>
        <Toast onClose={() => setShowToast(false)} show={showToast} delay={4000} autohide>
          <Toast.Header>
            <strong className="me-auto">Thông báo</strong>
          </Toast.Header>
          <Toast.Body>Đặt lịch thành công! Vui lòng chờ xác nhận lịch hẹn!</Toast.Body>
        </Toast>
      </ToastContainer>
    </>
  );
