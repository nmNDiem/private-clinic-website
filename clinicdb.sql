...
--
-- Host: localhost    Database: clinicdb3
-- ------------------------------------------------------
...
CREATE TABLE `doctor` (
  ...
  `gender` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
  `birthday` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `phone_number` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `nurse` (
  `id` int NOT NULL,
  `name` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `gender` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `birthday` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `phone_number` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `email` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `user_id` int DEFAULT NULL,
...
-- Dump completed on 2024-06-20 16:44:14
