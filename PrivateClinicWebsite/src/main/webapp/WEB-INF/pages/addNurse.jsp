...
<form:form method="post" action="${action}" modelAttribute="nurse">
    <form:errors path="*" element="div" cssClass="alert alert-danger"/>
    <div class="form-floating mb-3 mt-3">
        <form:input class="form-control" id="name" placeholder="Tên y tá" path="name"/> 
    ...
    <!--<div class="form-floating mb-3 mt-3">
        <%--<form:input class="form-control mt-3" id="user" placeholder="UserId" path="userId.id"/> --%>
        <label for="user">Id người dùng</label>    
    </div>-->
